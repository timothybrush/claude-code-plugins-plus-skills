# Alchemy Notify Webhook Operations: first-party evidence
...
- [Webhook types](https://www.alchemy.com/docs/reference/webhook-types)
- [Notify API quickstart](https://www.alchemy.com/docs/reference/notify-api-quickstart)
- [Create webhook endpoint](https://www.alchemy.com/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/create-webhook)
