# Alchemy Client and API Routing Patterns: first-party evidence
...
- [Wallet APIs reference](https://www.alchemy.com/docs/wallets/reference/wallet-apis)
- [Data APIs overview](https://www.alchemy.com/docs/data)
