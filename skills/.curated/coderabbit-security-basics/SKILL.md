...
description: >-
  Configure and audit security review capabilities as one layer in a defense-in-depth pull-request program. Use when this operator task needs a current, evidence-backed
  CodeRabbit workflow. Trigger with "secure CodeRabbit reviews".
...
tags: [saas, coderabbit, security, sast, defense-in-depth]
---
...
1. Classify threat model, sensitive paths, languages, builds, checks, and requirements.

2. Map risks to supported tools, guidance, external gates, or manual controls.

3. Configure supported layers and retain provider security checks.

4. Test safe seeded fixtures, record gaps, and define escalation.
