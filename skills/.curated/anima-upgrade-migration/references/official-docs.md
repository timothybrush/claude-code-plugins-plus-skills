# anima-upgrade-migration — Official Contract
...
Upgrade from a pinned version to an explicitly selected target, compare type/API changes and release notes, replay fixed synthetic fixtures, inspect generated diffs, and retain the prior lockfile plus output revision for rollback.
