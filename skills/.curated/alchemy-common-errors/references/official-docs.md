# Alchemy Error Classification and Recovery: first-party evidence
...
- [Portfolio partial-error behavior](https://www.alchemy.com/docs/reference/portfolio-apis)
- [Alchemy service status](https://status.alchemy.com/)
