# Alchemy Credential and Trust-Boundary Security: first-party evidence
...
- [Notify API quickstart and signatures](https://www.alchemy.com/docs/reference/notify-api-quickstart)
