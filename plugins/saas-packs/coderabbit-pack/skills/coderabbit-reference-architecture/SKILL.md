...
description: >-
  Design a governed deployment across provider, configuration, review, knowledge, tools, data, identity, and observability. Use when this operator task needs a current, evidence-backed
  CodeRabbit workflow. Trigger with "design CodeRabbit architecture".
...
tags: [saas, coderabbit, architecture, governance, integration]
---
...
- Repository YAML, central config, settings, and global overrides form precedence.
- CodeRabbit can use guidelines, learnings, linked repos, MCP, and tools.
- Provider support and auth differ.
- Dashboards, exports, reports, and APIs are distinct.
...
1. Map organizations, providers, repos, trust zones, data, identities, plans, and gates.

2. Draw configuration resolution and review-event flows with ownership.

3. Select knowledge, tools, cache, retention, reporting, and continuity controls.

4. Validate happy, exclusion, provider-failure, secret, and rollback paths.
