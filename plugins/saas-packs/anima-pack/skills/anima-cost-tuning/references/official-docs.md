# anima-cost-tuning — Official Contract
...
Anima does not publish a universal per-generation price or savings percentage in the SDK contract. Optimize measured duplicate work and asset transfer, then reconcile decisions against the customer agreement.
