# Alchemy Archived SDK Migration: first-party evidence
...
- [Archived SDK repository](https://github.com/alchemyplatform/alchemy-sdk-js)
...
- [Wallet APIs v5 migration](https://www.alchemy.com/docs/wallets/resources/migration-v5)
