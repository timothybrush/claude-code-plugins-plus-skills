# Alchemy Installation and Authentication Intake: first-party evidence
...
- [Archived Alchemy SDK repository and replacement guidance](https://github.com/alchemyplatform/alchemy-sdk-js)
- [Ethereum API quickstart with viem](https://www.alchemy.com/docs/reference/ethereum-api-quickstart)
- [Wallet APIs SDK quickstart](https://www.alchemy.com/docs/wallets/transactions/using-sdk)
- [Create access keys](https://www.alchemy.com/docs/how-to-create-access-keys)
