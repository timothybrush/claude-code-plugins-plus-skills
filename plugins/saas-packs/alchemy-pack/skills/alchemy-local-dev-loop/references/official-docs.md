# Alchemy Deterministic Local Development Loop: first-party evidence
...
- [Alchemy Sandbox](https://www.alchemy.com/docs/alchemy-sandbox)
- [Ethereum API quickstart](https://www.alchemy.com/docs/reference/ethereum-api-quickstart)
- [Supported chains](https://www.alchemy.com/docs/reference/node-supported-chains)
- [Throughput model](https://www.alchemy.com/docs/reference/throughput)
